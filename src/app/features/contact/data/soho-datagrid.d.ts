...
// interface SohoDataGridEditCellFunctionArgs
//   extends SohoDataGridPostRenderCellArgs {
//   container: any;
//   e: any;
//   item: any;
// }
...
// type SohoDataGridExpandRowResponseFunction = (markup: string) => void;
...
// type SohoDataGridBeforeSelectEventData = (node: JQuery, idx: number) => void;
...
//   container: JQuery,
//   args: SohoDataGridPostRenderCellArgs
// ) => void;

// type SohoDataGridEditCellFunction = (editor: any) => void;
...
// type SohoIsRowDisabledFunction = (actualIndex: number, rowData: any) => boolean;

// type SohoDataGridResultsTextFunction = (source: any, count: number) => {};

// type SohoDataGridSortFunction = (id: number, ascending: boolean) => boolean;

// type SohoDataGridColumnFilterType =
//   | 'text'
//   | 'checkbox'
//   | 'contents'
//   | 'date'
...
// type SohoDataGridColumnFilterConditions =
//   | 'contains'
//   | 'does-not-contain'
//   | 'equals'
//   | 'does-not-equal'
...
//   maskOptions?: SohoDataGridColumnMaskOptionsFunction;

//   /** The newer style object pattern mask for the column filter row only*/
//   filterMaskOptions?: SohoDataGridColumnMaskOptionsFunction;
...
// type SohoDataGridColumnNumberFormatStyle =
//   | 'decimal'
//   | 'currency'
//   | 'percent'
//   | 'integer'
//   | string;
// type SohoDataGridTriggerSourcePagerType =
//   | 'initial'
//   | 'refresh'
//   | 'filtered'
//   | 'sorted'
...
//     ascending: boolean | undefined | null
//   ): void;
...
//   applyFilter(
//     conditions?: Array<SohoDataGridFilterCondition> | null | undefined
//   ): void;
...
//   triggerSource(
//     pagerType: SohoDataGridTriggerSourcePagerType,
//     callback?: Function
//   ): void;
...
//     customDs: Object[] | null | undefined
//   ): void;
...
//   on(
//     events: 'cellchange' | 'activecellchange',
//     handler: JQuery.EventHandlerBase<any, SohoDataGridCellChangeEvent>
//   ): this;
//   on(
//     events: 'rowremove',
//     handler: JQuery.EventHandlerBase<any, SohoDataGridRowRemoveEvent>
//   ): this;
//   on(
//     events: 'settingschanged',
//     handler: JQuery.EventHandlerBase<any, SohoDataGridSettingsChangedEvent>
//   ): this;
//   on(
//     events: 'rendered',
//     handler: JQuery.EventHandlerBase<any, SohoDataGridRenderedEvent>
//   ): this;
//   on(
//     events: 'addrow',
//     handler: JQuery.EventHandlerBase<any, SohoDataGridAddRowEvent>
//   ): this;
//   on(
//     events: 'collapserow',
//     handler: JQuery.EventHandlerBase<any, SohoDataGridRowCollapseEvent>
//   ): this;
//   on(
//     events: 'expandrow',
//     handler: JQuery.EventHandlerBase<any, SohoDataGridRowExpandEvent>
//   ): this;
//   on(
//     events: 'click | dblclick | contextmenu',
//     handler: JQuery.EventHandlerBase<any, SohoDataGridRowClicked>
//   ): this;
//   on(
//     events: 'filtered',
//     handler: JQuery.EventHandlerBase<any, SohoDataGridFilteredEvent>
//   ): this;
//   on(
//     events: 'rowreorder',
//     handler: JQuery.EventHandlerBase<any, SohoDataGridRowReorderedEvent>
//   ): this;
//   on(
//     events: 'sorted',
//     handler: JQuery.EventHandlerBase<any, SohoDataGridSortedEvent>
//   ): this;
//   on(
//     events: 'beforepaging',
//     handler: JQuery.EventHandlerBase<any, SohoPagerPagingInfo>
//   ): this;
//   on(
//     events: 'afterpaging',
//     handler: JQuery.EventHandlerBase<any, SohoPagerPagingInfo>
...
//   ): this;
//   on(
//     events: 'rowactivated | beforerowactivated',
//     handler: JQuery.EventHandlerBase<any, SohoDataGridRowActivatedEvent>
//   ): this;
//   on(
//     events: 'rowdeactivated',
//     handler: JQuery.EventHandlerBase<any, SohoDataGridRowDeactivatedEvent>
//   ): this;
//   on(
//     events: 'selected',
//     handler: JQuery.EventHandlerBase<any, SohoDataGridSelectedRow[]>
//   ): this;
//   on(
//     events: 'filteroperatorchanged',
//     handler: JQuery.EventHandlerBase<
//       any,
//       SohoDataGridFilterOperatorChangedEvent
//     >
//   ): this;
// }
...
// interface SohoDataGridRowDeactivatedEvent
//   extends SohoDataGridRowActivatedEvent {}
